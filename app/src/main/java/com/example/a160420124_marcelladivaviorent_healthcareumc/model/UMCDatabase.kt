...
import com.example.a160420124_marcelladivaviorent_healthcareumc.util.MIGRATION_4_5

@Database(entities = [Doctor::class, Article::class, Facility::class, Drug::class, User::class], version = 5)
    ...
    companion object {
        ...
        private fun buildDatabase(context: Context) =
            Room.databaseBuilder(
                ...
                "umcdb").addMigrations(MIGRATION_1_2, MIGRATION_2_3, MIGRATION_3_4, MIGRATION_4_5).build()
